...
function AddList({setList}) {
    ...
    return(
        <form className='addForm' onSubmit={handleSubmit}>
            <input type="text" name="name" placeholder="Enter Patient Name" ref={nameRef}/>
            <input type="text" name="Gen" placeholder="Enter Patient Gender" ref={GenRef}/>
            <input type="text" name="Date_vis" placeholder="Enter Date_vis" ref={DateRef}/>
            <input type="text" name="Doc_id" placeholder="Enter Doc_id" ref={DocRef}/>
