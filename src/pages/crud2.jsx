...
function EditList({current, lists, setList}) {
    ...
    return(
        <tr>
            ...
            <td><input type="text" onChange={handInputAppDate} name='AppDate' value={current.AppDate}/></td>
            <td><input type="text" onChange={handInputAppTime} name='AppTime' value={current.AppTime}/></td>
