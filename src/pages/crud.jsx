...
function AddList({setList}) {
    ...
    return(
        ...
        <form className='addForm1' onSubmit={handleSubmit}>
            <input type="text" name="name" placeholder="Enter Doctor Name" ref={nameRef}/>
            <input type="text" name="dept" placeholder="Enter Doctor Dept" ref={deptRef}/>
            <input type="text" name="pat" placeholder="Enter Patient handling" ref={patRef}/>
